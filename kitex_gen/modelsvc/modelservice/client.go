...
type Client interface {
	...
	GetAPIKeyBySource(ctx context.Context, req *modelsvc.GetAPIKeyBySourceReq, callOptions ...callopt.Option) (r *modelsvc.APIKey, err error)
	GetAPIKeyByModel(ctx context.Context, req *modelsvc.GetAPIKeyByModelReq, callOptions ...callopt.Option) (r *modelsvc.APIKey, err error)
}
...
func (p *kModelServiceClient) GetAPIKeyBySource(ctx context.Context, req *modelsvc.GetAPIKeyBySourceReq, callOptions ...callopt.Option) (r *modelsvc.APIKey, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetAPIKeyBySource(ctx, req)
}

func (p *kModelServiceClient) GetAPIKeyByModel(ctx context.Context, req *modelsvc.GetAPIKeyByModelReq, callOptions ...callopt.Option) (r *modelsvc.APIKey, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetAPIKeyByModel(ctx, req)
}
